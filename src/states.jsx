...
const picbig={url: "https://www.bestbus.in/assets/images/news-cms/top_10_places_in_hyderabad.jpg"};

const head ={pagename : "Tourism Places"};

function Image(props){
    return<>
    <img style={{ width:"100%",height:"300px",paddingLeft:"0px",paddingRight:"0px"}} src={props.pic}  className="img-fluid"/>
    </>
  }
...
function StateName(){
    ...
    <div className="sub-nav">
            <Link to="/haryana" class="nav_1">Haryana</Link><hr></hr>
            <Link to="/haryana">Haryana</Link><hr></hr>
            <Link to="/haryana">Haryana</Link><hr></hr>
            <Link to="/haryana">Haryana</Link><hr></hr>
    ...
    <div className="sub-box2" id="Content">
